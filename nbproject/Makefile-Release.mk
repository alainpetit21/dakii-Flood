...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/floodpuzz: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/floodpuzz ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/AppFloodPuzz.o: src/AppFloodPuzz.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/AppFloodPuzz.o src/AppFloodPuzz.cpp

${OBJECTDIR}/src/CtxGame.o: src/CtxGame.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxGame.o src/CtxGame.cpp

${OBJECTDIR}/src/CtxScore.o: src/CtxScore.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CtxScore.o src/CtxScore.cpp
